...
- `scope.provide` IS used in transition.nix line 306 for policy handler injection during fan-out, which is a narrower use of the same nix-effects API.
